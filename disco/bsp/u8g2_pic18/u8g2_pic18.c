...
void my_u8g2_Setup_ssd1306_96x39_f(u8g2_t *u8g2, const u8g2_cb_t *rotation, u8x8_msg_cb byte_cb, u8x8_msg_cb gpio_and_delay_cb)
{
    ...
    buf = my_u8g2_m_12_5_f(&tile_buf_height);
    u8g2_SetupBuffer(u8g2, buf, tile_buf_height, u8g2_ll_hvline_vertical_top_lsb, rotation);
}

uint8_t my_u8x8_msg_cb(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
    return u8x8_d_ssd1306_96x39(u8x8, msg, arg_int, arg_ptr);
}

uint16_t my_u8x8_char_cb(u8x8_t *u8x8, uint8_t b)
{
    return 0;   
}
...
{
  return u8x8_cad_001(u8x8, msg, arg_int, arg_ptr);
}

uint8_t my_u8x8_byte_cb(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
    return u8x8_byte_4wire_sw_spi_pic18(u8x8,  msg,  arg_int, arg_ptr);
}

uint8_t my_u8x8_GPIO_cb(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
    return u8x8_gpio_and_delay_pic18(u8x8,  msg,  arg_int, arg_ptr);
}


const uint8_t u8g2_font_6x10_tf[2000] U8G2_FONT_SECTION("u8g2_font_6x10_tf") = 
