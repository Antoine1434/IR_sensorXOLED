...
# 88 "../../../../u8g2/csrc/u8x8_cad.c"
uint8_t u8x8_cad_SendCmd(u8x8_t *u8x8, uint8_t cmd)
{
return u8x8->cad_cb(u8x8, 21, cmd, (0));
}

uint8_t u8x8_cad_SendArg(u8x8_t *u8x8, uint8_t arg)
{
return u8x8->cad_cb(u8x8, 22, arg, (0));
}
...
uint8_t u8x8_cad_SendData(u8x8_t *u8x8, uint8_t cnt, uint8_t *data)
{
return u8x8->cad_cb(u8x8, 23, cnt, data);
}

uint8_t u8x8_cad_StartTransfer(u8x8_t *u8x8)
{
return u8x8->cad_cb(u8x8, 24, 0, (0));
}

uint8_t u8x8_cad_EndTransfer(u8x8_t *u8x8)
{
return u8x8->cad_cb(u8x8, 25, 0, (0));
}
...
while( *fmt != '\0' )
{
d = (uint8_t)(*(int *)__va_arg((*(int **)va), (int)0));
switch(*fmt)
{
...
case 24:
case 25:
u8x8->cad_cb(u8x8, cmd, 0, (0));
break;
case 0x0fe:
v = *data;
u8x8_gpio_call((u8x8), (41), (v));
data++;
break;
default:
return;
...
u8x8->byte_cb(u8x8, 23, arg_int, arg_ptr);
u8x8_byte_EndTransfer(u8x8);
}
...
while( arg_int > 24 )
{
u8x8->byte_cb(u8x8, 23, 24, p);
arg_int-=24;
p+=24;
u8x8_byte_EndTransfer(u8x8);
u8x8_byte_StartTransfer(u8x8);
u8x8_byte_SendByte(u8x8, 0x08);
}
u8x8->byte_cb(u8x8, 23, arg_int, p);
break;
case 20:
...
((u8x8)->i2c_address = (((u8x8)->i2c_address)&0x0fc));
u8x8_byte_StartTransfer(u8x8);
}
}
else
...
((u8x8)->i2c_address = ((((u8x8)->i2c_address)&0x0fc)|2));
u8x8_byte_StartTransfer(u8x8);
}
}
else
