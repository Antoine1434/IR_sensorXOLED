...
((u8x8)->gpio_and_delay_cb((u8x8), 40, 0, (0) ));
((u8x8)->cad_cb((u8x8), 20, 0, (0) ));


u8x8_gpio_call(u8x8, (64+(11)), (1));
u8x8_gpio_call((u8x8), (41), (u8x8->display_info->reset_pulse_width_ms));
u8x8_gpio_call(u8x8, (64+(11)), (0));
u8x8_gpio_call((u8x8), (41), (u8x8->display_info->reset_pulse_width_ms));
u8x8_gpio_call(u8x8, (64+(11)), (1));
u8x8_gpio_call((u8x8), (41), (u8x8->display_info->post_reset_wait_ms));
}
...
return u8x8->display_cb(u8x8, 15, 1, (void *)&tile);
}


void u8x8_SetupMemory(u8x8_t *u8x8)
{
u8x8->display_cb(u8x8, 9, 0, (0));
}
...
void u8x8_InitDisplay(u8x8_t *u8x8)
{
u8x8->display_cb(u8x8, 10, 0, (0));

}

void u8x8_SetPowerSave(u8x8_t *u8x8, uint8_t is_enable)
{
u8x8->display_cb(u8x8, 11, is_enable, (0));
}

void u8x8_SetFlipMode(u8x8_t *u8x8, uint8_t mode)
{
u8x8->display_cb(u8x8, 13, mode, (0));
}

void u8x8_SetContrast(u8x8_t *u8x8, uint8_t value)
{
u8x8->display_cb(u8x8, 14, value, (0));
}

void u8x8_RefreshDisplay(u8x8_t *u8x8)
{
u8x8->display_cb(u8x8, 16, 0, (0));
}
...
do
{
u8x8->display_cb(u8x8, 15, u8x8->display_info->tile_width, (void *)&tile);
tile.y_pos++;
} while( tile.y_pos < h );
}
