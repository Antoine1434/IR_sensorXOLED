...
# 1 "../../../src/OLED_W_display.c"


# 10 "../../../../common/include/pic18fx7k40_config.h"
...
# 52 "C:\Program Files\Microchip\xc8\v2.20\pic\include\proc\pic18f27k40.h"
...
# 50 "../../../../rn52/include/rn52.h"
uInt8_t rn52_init(void);

# 57
uInt8_t rn52_cmd(const uInt8_t *cmd);

# 30 "../../../../adc/include/adc.h"
void adc_init(void);

# 37
uInt8_t adc_read(void);

# 50 "../../../../lcd/include/lcd.h"
...
# 28 "../../../../IRsensor/include/IRsensor.h"
...
int8_t u8x8_byte_4wire_sw_spi_pic18(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr);
...
LATBbits.LATB0 = 1;
SSP1BUF = 0xFF; while( !SSP1STATbits.BF );;
...
for(uInt8_t col = 0; col < 128; col++){
LATBbits.LATB0 = 1;
SSP1BUF = 0x00; while( !SSP1STATbits.BF );;
}
}
LATBbits.LATB2 = 1;
