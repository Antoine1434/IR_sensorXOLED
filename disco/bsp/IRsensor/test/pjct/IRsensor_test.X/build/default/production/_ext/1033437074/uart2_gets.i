...
# 1 "../../../../uart2_correction/src/uart2_gets.c"
...
# 9 "../../../../uart2_correction/src/uart2_gets.c"
uInt8_t uart2_gets(uInt8_t *str_buf, uInt8_t buf_limit, uInt8_t echo)
{
static uInt8_t i = 0;
uInt8_t tmp;

do {
if (!uart2_getc(&tmp, echo))
goto fail_nopayload;
