...
# 1 "../../../../uart1_correction/src/uart1_getc.c"
...
# 17 "../../../../uart1_correction/src/uart1_getc.c"
...
# 29
if ( uart1_rx.nb_elt < 20 ) {
uart1_rx.buffer[uart1_rx.idx_write] = RC1REG;
uart1_rx.nb_elt++;
uart1_rx.idx_write++;

if ( uart1_rx.idx_write >= 20 )
uart1_rx.idx_write = 0;

# 41
if ( uart1_rx.nb_elt == (20 - 4) ) {
...
if ( uart1_rx.idx_read >= 20 )
uart1_rx.idx_read = 0;

# 68
if (uart1_rx.nb_elt == (20 >> 1)) {
uart1_putc(0x11);
}
