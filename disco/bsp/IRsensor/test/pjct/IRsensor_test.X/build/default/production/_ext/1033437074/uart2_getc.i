...
# 1 "../../../../uart2_correction/src/uart2_getc.c"
...
# 17 "../../../../uart2_correction/src/uart2_getc.c"
...
# 29
if ( uart2_rx.nb_elt < 20 ) {
uart2_rx.buffer[uart2_rx.idx_write] = RC2REG;
uart2_rx.nb_elt++;
uart2_rx.idx_write++;

if ( uart2_rx.idx_write >= 20 )
uart2_rx.idx_write = 0;

# 41
if ( uart2_rx.nb_elt == (20 - 4) ) {
...
if (uart2_rx.idx_read >= 20)
uart2_rx.idx_read = 0;

# 68
if (uart2_rx.nb_elt == (20 >> 1)) {
uart2_putc(0x11);
}
