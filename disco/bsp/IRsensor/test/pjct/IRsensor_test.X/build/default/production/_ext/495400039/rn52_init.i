...
# 1 "../../../../rn52_correction/src/rn52_init.c"
...
# 9 "../../../../rn52_correction/src/rn52_init.c"
uInt8_t rn52_init(void)
{
uInt8_t rn52_ack[10], lost;

# 16
INTCONbits.IPEN = 1; INTCONbits.GIEH = 1; INTCONbits.GIEL = 1;
...
# 34
while (!uart2_gets(rn52_ack, 10, 0));
while (!uart2_getc(&lost, 0));

if (strcmp(rn52_ack, "CMD"))
goto fail_activation;


if (!rn52_cmd("SN,ABCDEF"))
goto fail_cmd_ack;
